...
int  C_CBYParser_1::GetParentIndex(C_STR szParentName)
{
...
bool C_CBYParser_1::Load(const TCHAR* szFileName)
{
...
BOOL  C_CBYParser_1::OpenStream(const TCHAR* filename)
{
...
BOOL  C_CBYParser_1::CloseStream()
{
	fclose(m_pStream);
	return TRUE;
}

bool C_CBYParser_1::Release()
{
	m_ObjList.clear();
	m_MtlList.clear();
