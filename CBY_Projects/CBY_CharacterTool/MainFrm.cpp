...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_WndMapCtrl_0.CreateEx(NULL, L"Character", this, CRect(0, 0, 100, 100), TRUE, 10000, dwStyle);
	m_WndMapCtrl_1.CreateEx(NULL, L"Char_Set", this, CRect(0, 0, 100, 100), TRUE, 10001, dwStyle);
	m_WndPSLCtrl.CreateEx(NULL, L"Char PSL", this, CRect(0, 0, 100, 100), TRUE, 10003, dwStyle);

	m_WndMapCtrl_0.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_WndMapCtrl_0);

	m_WndMapCtrl_1.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_WndMapCtrl_1);

	m_WndPSLCtrl.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_WndPSLCtrl);
