...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_WndMapCtrl_0.CreateEx(NULL, L"View", this, CRect(50, 50, 150, 150), TRUE, 10000, dwStyle);
	m_WndMapCtrl_1.CreateEx(NULL, L"Trans", this, CRect(50, 50, 150, 150), TRUE, 10001, dwStyle);
