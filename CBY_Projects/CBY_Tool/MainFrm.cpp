...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_TOOL_LOAD, &CMainFrame::OnToolLoad)
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_WndMapCtrl.CreateEx(NULL, L"Map", this, CRect(0, 0, 100, 100), TRUE, 1000, dwStyle);
...
void CMainFrame::OnToolLoad()
{
	CBY_ObjectLoad obj;
	if (obj.GetSafeHwnd() == NULL)
	{
		obj.Create(IDD_CBY_ObjectLoad);
	}
