...
HRESULT CBY_DxRT::Create(ID3D11Device* pd3dDevice,float fWidth,float fHeight)
{
	HRESULT hr;
...
HRESULT CBY_DxRT::UpdateDepthStencilView(ID3D11Device* pDevice, UINT Width, UINT Height)
{
	HRESULT hr;
...
bool CBY_DxRT::Begin(ID3D11DeviceContext* pContext,
	D3DXVECTOR4 vColor)
{
	m_iViewPorts = 1;
...
bool CBY_DxRT::End(ID3D11DeviceContext* pContext)
{
...
HRESULT CBY_DxRT::SaveFile(ID3D11DeviceContext* pContext, T_STR name)
{
	HRESULT hr;
