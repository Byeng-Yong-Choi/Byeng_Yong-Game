...
HRESULT CBY_Minimap::Create(ID3D11Device* pd3dDevice, ID3D11DeviceContext* Context)
{
	m_pd3dDevice = pd3dDevice;
	m_Context = Context;
	m_pMiniMap = std::make_shared<CShapeObject>();
...
void CBY_Minimap::SetMatrix(D3DXMATRIX* world, D3DXMATRIX* view, D3DXMATRIX* proj)
{
	m_pMiniMap->SetMatrix(world, &m_matTopView, &m_matTopProj);
}

bool CBY_Minimap::Render()
{
