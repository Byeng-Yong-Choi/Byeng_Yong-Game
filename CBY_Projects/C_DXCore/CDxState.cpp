...
namespace CDX
{
	...
	ID3D11SamplerState*  CDxState::g_pSamplShadow = nullptr;
	ID3D11SamplerState*  CDxState::g_pSSClampPoint = nullptr;
	ID3D11SamplerState*  CDxState::g_pSSClampLinear = nullptr;
	...
	ID3D11RasterizerState* CDxState::g_pRSDepth = nullptr;
	...
	bool CDxState::Release()
	{
		g_pDSS->Release();
		g_pSampler->Release();
		g_pSamplShadow->Release();
		g_pSSClampPoint->Release();
