...
HRESULT CShapeLine::CreateInputLayout()
{
	HRESULT hr = S_OK;
...
HRESULT CShapeLine::CreateVertexData()
{
	HRESULT hr = S_OK;
...
HRESULT CShapeLine::CreateIndexData()
{
	HRESULT hr = S_OK;
...
HRESULT CShapeLine::CreateVertexBuffer()
{
	HRESULT hr = S_OK;
...
bool	CShapeLine::Draw(D3DXVECTOR3 v0, D3DXVECTOR3 v1, D3DXVECTOR4 color)
{
