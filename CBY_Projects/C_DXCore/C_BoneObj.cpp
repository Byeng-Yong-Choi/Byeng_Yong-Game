...
void C_BoneObj::MTRUpdate(int iStart, int iEnd, float fTime, D3DXMATRIX* pMatrixList)
{
	CMatSetData matdata;
...
void    C_BoneObj::Convert(std::vector<PNCT2IW_VERTEX>& list)
{
	int iBaseVertex = 0;
	int iBaseIndex = 0;
	int iBaseOffset = 0;
...
void C_BoneObj::ObjUpdate(int iStart, int iEnd, float fTime, D3DXMATRIX* pMatrixList, D3DXMATRIX* parmat, int socket)
{
	CMatSetData matdata;
