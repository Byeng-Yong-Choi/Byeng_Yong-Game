...
void    C_CBYObj_1::Convert(std::vector<PNCT2IW_VERTEX>& list)
{
	int iBaseVertex = 0;
	int iBaseIndex = 0;
	int iBaseOffset = 0;
...
void C_CBYObj_1::ObjUpdate(D3DMATRIX* parmat, D3DMATRIX& matcal)
{
	float fTime = 0;
...
void C_CBYObj_1::Draw(CBY_MeshSkin* mesh)
{
...
void	C_CBYObj_1::CreateVIData(CBY_MeshSkin* mesh)
{
	HRESULT hr = S_OK;
