...
void C_DebugCamera::MsgProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void C_DebugCamera::Update(D3DXVECTOR4 rotvalue)
{
	D3DXQUATERNION qRot;
	D3DXMATRIX matRot;
