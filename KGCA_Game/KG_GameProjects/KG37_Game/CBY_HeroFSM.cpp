...
namespace CBY
{
	bool CBY_HeroFSM::Init()
	{
		...
		Input(CHAR_IDLE, EVENT_RELOAD, CHAR_RELOAD);
		...
		Input(CHAR_MOVE, EVENT_RUN, CHAR_RUN);
		Input(CHAR_MOVE, EVENT_RELOAD, CHAR_RELOAD);
		...
		Input(CHAR_JUMP, EVENT_DAMAGE, EVENT_DAMAGE);
		...
		Input(CHAR_FIRE, EVENT_RELOAD, CHAR_RELOAD);

		//Reload
		Input(CHAR_RELOAD, EVENT_IDLE, CHAR_IDLE);
		Input(CHAR_RELOAD, EVENT_DAMAGE, CHAR_DAMAGE);
		Input(CHAR_RELOAD, EVENT_DEATH, CHAR_DEATH);
		Input(CHAR_RELOAD, EVENT_MOVE, CHAR_MOVE);
		Input(CHAR_RELOAD, EVENT_RUN, CHAR_RUN);

		//Damage
		Input(CHAR_DAMAGE, EVENT_IDLE, CHAR_IDLE);
		Input(CHAR_DAMAGE, EVENT_DAMAGE, CHAR_DAMAGE);
		Input(CHAR_DAMAGE, EVENT_DEATH, CHAR_DEATH);

		//Death
		Input(CHAR_DEATH, EVENT_CREATE, CHAR_IDLE);
		Input(CHAR_DEATH, EVENT_DAMAGE, CHAR_DEATH);
