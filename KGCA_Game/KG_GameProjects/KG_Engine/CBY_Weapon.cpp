...
namespace CBY
{
	bool CBY_Weapon::Update(D3DXMATRIX* parmat)
	{
		...
		D3DXMatrixRotationYawPitchRoll(&matrot, m_vRotInfo.x, m_vRotInfo.y, m_vRotInfo.z);
		D3DXMatrixScaling(&matscale, m_fScale, m_fScale, m_fScale);
		matscale *= poaworld * matrot;

		matscale._41 = vPos.x+ m_vMovePos.x;
		matscale._42 = vPos.y+ m_vMovePos.y;
		matscale._43 = vPos.z+ m_vMovePos.z;
		...
		{
			m_Bone->ObjUpdate(0, 0, 0, m_pMatrixList, &matscale, m_iObjSocket);
		}
